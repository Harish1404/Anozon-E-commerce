...
const Signup = () => {
  ...
  const { signup, login, isLoading, error, isAuth, clearError } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden backdrop-blur-lg bg-opacity-95">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-8 text-center">
            ...
            <p className="text-purple-100 text-sm">Join our community today and get started</p>
          </div>
          ...
          <div className="px-6 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="flex items-center justify-between mt-2">
                  {errors.username && (
                    <p className="text-red-600 text-xs font-medium">{errors.username}</p>
                  )}
                  {!errors.username && formData.username && (
                    <p className="text-green-600 text-xs font-medium">✓ Username looks good</p>
                  )}
              ...
              <div>
                ...
                {!errors.email && formData.email && validateEmail(formData.email) && (
                  <p className="text-green-600 text-xs mt-2 font-medium">✓ Email is valid</p>
                )}
              </div>
                    ...
                    {showPassword ? (
                      ...
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          ...
                          clipRule="evenodd"
                        />
                        <path d="M15.171 13.576l1.474 1.474a1 1 0 001.414-1.414l-14-14a1 1 0 00-1.414 1.414l1.474 1.474A10.014 10.014 0 00.458 10C1.732 14.057 5.522 17 10 17a9.958 9.958 0 004.512-1.074l1.474 1.474a1 1 0 001.414-1.414l-14-14a1 1 0 00-1.414 1.414l1.474 1.474z" />
                      </svg>
                    )}
                  </button>
                </div>
              ...
              <div>
                ...
                {errors.confirmPassword && (
                  <p className="text-red-600 text-xs mt-2 font-medium">{errors.confirmPassword}</p>
                )}
                {!errors.confirmPassword && formData.confirmPassword && formData.password === formData.confirmPassword && (
                  <p className="text-green-600 text-xs mt-2 font-medium">✓ Passwords match</p>
                )}
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-3 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition-all">
